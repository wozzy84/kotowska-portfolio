...
//     className={classNames(
//       cardStyle,
//       "self-stretch px-9 py-8 rounded-2xl flex-col justify-start items-center gap-4 flex"
//     )}
//   >
//     <h3 className={headerTextStyle}>Quick contact</h3>
//     <p className={descriptionTextStyle}>
...
//       className={classNames(
//         inputsStyle,
//         "h-[206px] w-full flex-col justify-start items-start gap-2 flex"
//       )}
//     >
//       <input
//         type="email"
...
//         className={"w-full h-12 px-4"}
//       />
//       <div className="h-[94px] w-full flex-col justify-start items-start flex">
//         <div className="self-stretch h-[94px] flex-col justify-start items-start flex">
//           <div className="self-stretch h-[94px] rounded-sm flex-col justify-center items-start flex">
//             <div className="self-stretch h-[94px] px-4 bg-[#f2f5f7] rounded-lg flex-col justify-center items-start gap-3 flex">
//               <div className="h-[0px] relative" />
//               <div className="self-stretch justify-between items-center inline-flex">
//                 <div className="grow shrink basis-0 h-[70px] justify-start items-center gap-1 flex">
//                   <div className="grow shrink basis-0 opacity-80 text-[#5f6367] text-sm font-normal font-['Inter'] leading-[18px]">
//                     Message
//                     <br />
//                     <br />
//                   </div>
...
//                 <div />
//               </div>
//               <div className="w-72 h-[0px] relative" />
//             </div>
//           </div>
//         </div>
//       </div>
