...
const cardContent: PortfolioCardProps[] = [
  {
    tag: "Mobile App",
    subtitle: "Designing an AED Access App: Life-Saving Simplicity",
    description:
  ...
  {
    tag: "Cross-platform",
    subtitle: "Enhancing WorkZone: User-Centric Design for KMD's EIM Platform",
    description:
  ...
  {
    tag: "Web Platform",
    subtitle: "Carrotspot – HR Operations Platform for LUX MED Group",
    description:
  ...
  {
    tag: "Web Design",
    subtitle: "Unifying a Complex Website System for Sustainable Brands",
    description:
