...
const { sectionStyle, sectionBlurStyle } = TrustedBySectionStyle;
...
const TrustedBySection: React.FC = () => {
  return (
    <section
      className={classNames("flex justify-center items-center", sectionStyle)}
    >
      <div className={classNames("w-full h-full pt-8 pb-6", sectionBlurStyle)}>
