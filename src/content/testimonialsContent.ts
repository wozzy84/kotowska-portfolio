...
export const testimonialsContent:TestimonialContent[] = [
    {
        ...
        image: "/images/testimonial-kopacki.webp",
        name: "-- Paweł Kopacki",
        job: "then Online Sales & Traffic Manager \n @ Burda Media Polska"
    },
        {
        ...
        image: "/images/testimonial-brzezinski.webp",
        name: "-- Piotr Brzeziński",
        job: "then Head of Development \n @ KMD"
    },
            {
        ...
        image: "/images/testimonial-telus.webp",
        name: "-- Wojciech Telus",
        job: "Team Leader \n @ LUX MED Benefity"
    }
]